    ...
    return (
        ...
        <div className=" container">
            <div className="myproj">
                      ...
                      <div className="box">
                        <h1 className="projtext">Banking System</h1>
                        <p className="projtext2">
                ...
                <div className="box">
                  <h1 className="projtext">The Snake Game</h1>
                  <p className="projtext2">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ab, corrupti!
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Reprehenderit, nisi.
                  ...
                  <div className="box">
                    <h1 className="projtext">The Avengers </h1>
                    <p className="projtext2">hello
                  ...
                  <div className="box">
                    <h1 className="projtext">Instagram Clone</h1>
                    <p className="projtext2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum, cum?
